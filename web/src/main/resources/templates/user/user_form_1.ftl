<@layout.extends name="layout/base_3.ftl">
            ...
            <div class="tab-content">
                <div class="clearfix m-b-20">
                    <div class="pull-right">
                        ...
                        <button class="btn btn-info btn-cons pull-right" type="button" onclick="javascript:location.href='/'">
                            <i class="pg-form"></i> <span>Login</span>
                        </button>
                    </div>
                </div>
            </div>
                ...
                if($('#frm').valid()) {
                    ...
                    if(pwd != pwd_check) {
                        ...
                        $.ajax({
                            ...
                            error: function (data) {
                                console.log(data);
                                NoticeCommon.Dialog.alert('등록오류입니다.');
