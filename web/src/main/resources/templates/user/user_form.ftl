                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="radio radio-success">
                                            <input type="radio" name="adminType" value="EMP" id="user_type01" <#if (member.adminType)?default("EMP")  == "EMP">checked</#if> />
                                            <label for="user_type01">일반</label>
                                            <input type="radio" name="adminType" value="DEPT" id="user_type02" <#if (member.adminType)?default("EMP")  == "DEPT">checked</#if> />
                                            <label for="user_type02">부서관리자</label>
                                            <input type="radio" name="adminType" value="HR" id="user_type05" <#if (member.adminType)?default("EMP")  == "HR">checked</#if> />
                                            <label for="user_type05">인사관리자</label>
                                            <input type="radio" name="adminType" value="RECORD" id="user_type03" <#if (member.adminType)?default("EMP")  == "RECORD">checked</#if> />
                                            <label for="user_type03">실적관리자</label>
                                            <#if user.adminType == 'ADMIN'>
                                            <input type="radio" name="adminType" value="ADMIN" id="user_type04" <#if (member.adminType)?default("EMP")  == "ADMIN">checked</#if> />
