        ...
        <div class="pd7">
            ...
            <div class="bg_wh">
                <form>
                    ...
                    <input id="" type="file" class="attach_file" name="fileName" onchange="javascript:document.getElementById('eventFile').value=this.value" onkeydown="return flase" >
    ...
    <script type="text/javascript">
        ...
        $("#jsGrid").jsGrid({
            ...
            fields: [
                ...
                { name: "이벤트11", type: "number", width: 100 , align: "center"},
                { name: "이벤트12", type: "number", width: 100 , align: "center"},
                { name: "이벤트13", type: "number", width: 100 , align: "center"},
                { name: "이벤트14", type: "number", width: 100 , align: "center"},
                { name: "이벤트15", type: "number", width: 100, align: "center" }
            ]
        });
    </script>
	</@layout.put>
