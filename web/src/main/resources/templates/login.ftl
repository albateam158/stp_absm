        ...
        <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
            ...
            <form id="form-login" action="/auth" method="post" class="p-t-15" role="form" autocomplete="off">
                ...
                <div class="form-group form-group-default">
                    <label>Login</label>
                    <div class="controls">
                        <input type="text" name="username" placeholder="사원번호" class="form-control" required>
                    </div>
                </div>
                <!-- END Form Control-->
                <!-- START Form Control-->
                ...
                <div class="row">
                    ...
                    <#--<button class="btn btn-info btn-cons pull-right" type="button" onclick="javascript:location.href='/user/form_pre'">-->
                        <#--<i class="pg-form"></i> <span>Join</span>-->
                    <#--</button>-->
                ...
                <div class="row">
                    ...
                    <input type="button" class="btn btn-primary btn-cons pull-right m-t-10 go-add" value="Join" onclick="javascript:location.href='/user/form_pre'">
                </div>
            </form>
            <!--END Login Form-->
