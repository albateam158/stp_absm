<@layout.extends name="layout/base.ftl">
    ...
    <script type="text/javascript">
        ...
        $( document ).ready(function() {
            ...
            var paging = new Paging('#paging_div', '#emp_list', '/emp/phone_div', 'dt', 'desc', '#search_form', function(){
            ...
            $('#search_form').submit(function(){
                ...
                paging.url = '/emp/phone_div?sort='+paging.sortField+','+paging.sortOrder;
                paging.loadDiv();
