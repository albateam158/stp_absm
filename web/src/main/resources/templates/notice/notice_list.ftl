<@layout.extends name="layout/base.ftl">
    ...
    <div class="container-fluid container-fixed-lg bg-white">
        ...
        <div class="panel panel-transparent">
            <div class="panel-body">
                ...
                <div id="notice_list_div" class="table-responsive m-t-30">
                ...
                <div class="clearfix m-t-20">
                    ...
                    <div class="pull-right">
                        <a href="/notice/form" class="btn btn-info btn-cons pull-right" style="min-width:100px;">
    ...
    <script type="text/javascript">
        ...
        $( document ).ready(function() {
            ...
            var paging = new Paging('#notice_list_div', '#notice_list_table', '/notices/list_div', 'reg_date', 'desc', '#search_form', function(){
