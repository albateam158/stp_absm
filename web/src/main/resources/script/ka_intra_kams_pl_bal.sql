...
--
-- Table structure for table `kams_pl_bal`
--

DROP TABLE IF EXISTS `kams_pl_bal`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `kams_pl_bal` (
...
--
-- Dumping data for table `kams_pl_bal`
--

LOCK TABLES `kams_pl_bal` WRITE;
/*!40000 ALTER TABLE `kams_pl_bal` DISABLE KEYS */;
/*!40000 ALTER TABLE `kams_pl_bal` ENABLE KEYS */;
UNLOCK TABLES;
