...
--
-- Table structure for table `kams_board_media`
--

DROP TABLE IF EXISTS `kams_board_media`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `kams_board_media` (
...
--
-- Dumping data for table `kams_board_media`
--

LOCK TABLES `kams_board_media` WRITE;
/*!40000 ALTER TABLE `kams_board_media` DISABLE KEYS */;
/*!40000 ALTER TABLE `kams_board_media` ENABLE KEYS */;
UNLOCK TABLES;
