<table id="project_update_list_table" class="table basic table-striped dataTable">
    <thead>
    <tr>
    ...
    <tbody>
        <#if projectUpdates?has_content>
            <#list projectUpdates as update>
                <tr update_id="${(update.updateId) !}">
                    ...
                    <td class="v-align-middle text-center">
                        <p><a href="/project/${(update.projectId) !}/update/${(update.updateId) !}">${update.title}</a></p>
                    </td>
                    <td class="v-align-middle text-center">
