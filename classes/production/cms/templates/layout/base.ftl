...
<nav class="page-sidebar" data-pages="sidebar">
    ...
    <div class="sidebar-menu" id="sidebar-menu">
        ...
        <ul class="menu-items">
            ...
            <li class="m-t-30">
                <a href="#">
                    <span class="title">사내 게시판</span>
                </a>
                <span class="icon-thumbnail"><i class="fa fa-comment-o"></i></span>
                <ul class="sub-menu">
                    <li>
                        <a href="/notice/list">공지사항</a>
                        <span class="icon-thumbnail">공지</span>
                    </li>
                </ul>
            </li>
            <li>
                <a href="#">
                    <span class="title">사내 연락망</span>
                </a>
                <span class="icon-thumbnail"><i class="fa fa-phone"></i></span>
                <ul class="sub-menu">
                    <li>
                        <a href="/emp/phoneBook">전화번호부</a>
                        <span class="icon-thumbnail">전화</span>
                    </li>
                    <li>
                        <a href="/dept/list">조직도</a>
                        <span class="icon-thumbnail">조직</span>
                    </li>
                    <li>
                        <a href="/company/location">회사위치</a>
                        <span class="icon-thumbnail">위치</span>
                    </li>
                </ul>
            </li>
            ...
            <li>
                <a href="#">
                    <span class="title">인사관리</span>
                </a>
                <span class="icon-thumbnail"><i class="fa-smile-o"></i></span>
                <ul class="sub-menu">
                    <li>
                        <a href="/emp/list">사원정보</a>
                        <span class="icon-thumbnail">사원</span>
                    </li>
                    <li>
                        <a href="/dept/list">부서정보</a>
                        <span class="icon-thumbnail">부서</span>
                    </li>
                </ul>
            </li>
            <li>
                <a href="#">
                    <span class="title">실적관리</span>
                </a>
                <span class="icon-thumbnail"><i class="fa fa-area-chart"></i></span>
                <ul class="sub-menu">
                    <li>
                        <a href="/record/list">실적조회</a>
                        <span class="icon-thumbnail">조회</span>
                    </li>
                    <li>
                        <a href="/record/form">실적입력</a>
                        <span class="icon-thumbnail">입력</span>
                    </li>
                    <li>
                        <a href="/record/stats">실적통계</a>
                        <span class="icon-thumbnail">통계</span>
                    </li>
                </ul>
            </li>
            <#if user.adminType == 'ADMIN'>
                <li>
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a href="/user/list">사용자</a>
                            <span class="icon-thumbnail">목록</span>
                        </li>
                    </ul>
                </li>
            </#if>
    ...
    <div class="header ">
        ...
        <div class=" pull-right">
            ...
            <div class="visible-lg visible-md m-t-20">
                <div class="pull-left fs-14 b-grey b-r no-style p-l-30 p-r-20 font-heading">
                    <span class="semi-bold" id="adminForm" style="cursor: pointer;">${(user.name) !}</span>
                </div>
                <div class="pull-left fs-14 p-l-30">
                    <a href="/logout" class="clearfix">
                        <span class="pull-left">Logout</span>
                        <span class="pull-right p-l-5"><i class="pg-power"></i></span>
                    </a>
                </div>
            </div>
            <!-- END User Info-->
