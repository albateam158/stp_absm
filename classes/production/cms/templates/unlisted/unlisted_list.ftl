<@layout.extends name="layout/base.ftl">
                ...
                <div class="panel panel-transparent">
                    <div class="panel-header">
                        <div class="no-padding m-b-10">
                            <h3>Unlisted</h3>
                            <p>WiCrowd 비상장 기업 목록을 보는 페이지 입니다.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid container-fixed-lg bg-white">
        ...
        <div class="panel panel-transparent">
            <div class="panel-body">
                ...
                <div id="unlisted_list_div" class="table-responsive m-t-30">
                ...
                <div class="clearfix m-t-20">
                    ...
                    <div class="pull-right">
                        ...
                        <a href="/unlisted/form" class="btn btn-info btn-cons pull-right" style="min-width:100px;">
                            <i class="fa fa-plus"></i> <span>Add Unlisted</span>
                        </a>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        $( document ).ready(function() {
            var paging = new Paging('#unlisted_list_div', '#unlisted_list_table', '/unlisted/list_div', 'reg_date', 'desc', '#search_form', function(){
            });
            paging.initPaging();
            ...
            $("button.delete").click(function()
            {
                ...
                $("#unlisted_list_table tbody .unit").each(function() {
                    if($(this).is(':checked'))
                    {
                        if(unlisted_count == 0) {
                            unlisted_ids = $(this).parent().parent().parent().attr('unlisted_id');
                        } else {
                            unlisted_ids += ',' + $(this).parent().parent().parent().attr('unlisted_id');
                        }
                        unlisted_count++;
                ...
                if(unlisted_count == 0) {
                    ...
                    NoticeCommon.Dialog.confirm({
                        content: '선택된 비상장기업을 삭제하시겠습니까?'
                        ,ok: function(){
                            $.ajax({
                                url: "/unlisted?unlistedIds="+unlisted_ids,
                                type: "DELETE",
                                dataType: 'json',
                                data: '',
            ...
            {
                $("#modalDiv").load("/unlisted/lineup", function(responseTxt, statusTxt, xhr){
