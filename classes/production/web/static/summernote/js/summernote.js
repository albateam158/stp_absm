    ...
    var tplDialogs = function (lang, options) {
      ...
      var tplLinkDialog = function () {
        var body = '<div class="form-group">' +
                     ...
                     '<input class="note-link-text form-control span12" type="text" value="" />' +
                   '</div>' +
                   ...
                   (!options.disableLinkTarget ?
                     '<div class="checkbox">' +
                       '<input type="checkbox" id="newWindowCheck" checked> ' +
                       '<label for="newWindowCheck">' +
      ...
      var tplVideoDialog = function () {
        var body = '<div class="form-group">' +
                     ...
                     '<input class="note-video-url form-control span12" type="text" value="" />' +
                   '</div>';
